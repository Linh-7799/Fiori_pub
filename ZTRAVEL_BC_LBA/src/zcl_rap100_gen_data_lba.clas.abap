CLASS zcl_rap100_gen_data_lba DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_lba IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'LBA',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravlba.
*    DELETE FROM zrap100_atravlba.

    "insert travel demo data
    INSERT zrap100_atravlba  FROM (
        SELECT
